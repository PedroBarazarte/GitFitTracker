...
<header>
  <div class="menu">
    <div class="contenedor">
      <p class="logo">FitTracker</p>
      <img src="/images/menu.png" class="menu-icon" alt="">
      <nav>
        <ul>
          <li><a href="">Index</a></li>
          <li><a href=""> FitTracker</a></li>
          <li><a href="/view/Eventosimportantes.php">Eventos Importantes</a></li>
          <li><a href="FitTraker/public/view/Eventosespeciales.php">Equipo de trabajo</a></li>
        </ul>
      </nav>
    </div>
  </div>
...
<section id="programs">
  <div class="contenedor">
    <div class="rojo cero">0</div>
    <div class="rojo ini">USUARIOS</div>
    <div class="rojo cero">0</div>
    <div class="rojo ini">GIMNASIOS</div>
